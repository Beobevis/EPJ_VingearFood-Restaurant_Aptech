    ...
    <div class="container">
        ...
        <div class="col-12 tm-block-col">
            <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-scroll">
                <h2 class="tm-block-title">RESERVATION REPORT LIST</h2>
                <table class="table">
                    <thead>
                    <tr>
                        <th scope="col">NO.</th>
                    ...
                    <?php if (!empty($datas)): ?>
                        <?php foreach ($datas as $data): ?>
                            ...
                            <tr>
                                <th scope="row"><b><?php echo $data['ReservationId'] ?></b></th>
                                <td><b><?php echo $data['ReservationName'] ?></b></td>
                                <td><b><?php echo $data['ReservationEmail'] ?></b></td>
                                <td><?php echo $data['ReservationPhone'] ?></td>
                                <td><?php echo $data['ReservationDate'] ?></td>
                                <td><?php echo $data['ReservationTime'] ?></td>
                                <td><?php echo $data['ReservationPerson'] ?></td>
                            </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
