        ...
        <div class="container">
            ...
            <div class="col-12 tm-block-col">
                <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-scroll">
                    <h2 class="tm-block-title">FEEDBACK REPORT LIST</h2>
                    <table class="table">
                        <thead>
                            <tr>
                                <th scope="col">NO.</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row"><b><?php echo $data['FeedbackId'] ?></b></th>
                                <td><b><?php echo $data['FBName'] ?></b></td>
                                <td><b><?php echo $data['FBDate'] ?></b></td>
                                <td><b><?php echo $data['FBEmail'] ?></b></td>
                                <td>0<?php echo $data['FBPhone'] ?></td>
                                <td><?php echo $data['FBComment'] ?></td>
                            </tr>
							  <?php endforeach; ?>
							<?php endif; ?>
                        </tbody>
