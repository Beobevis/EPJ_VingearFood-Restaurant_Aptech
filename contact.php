        ...
        <div class="container">
            <div class="row d-flex contact-info">
                ...
                <div class="col-md-3 d-flex">
                    <div class="dbox">
                        <p><span>Address:</span> 285 Doi Can, Ba Dinh, Ha Noi</p>
                    </div>
                </div>
                <div class="col-md-3 d-flex">
                    <div class="dbox">
                        <p><span>Phone:</span> <a href="tel://19000019">+84 1900-0019</a></p>
                    </div>
                </div>
                <div class="col-md-3 d-flex">
                    <div class="dbox">
                        <p><span>Email:</span> <a href="mailto:contact@vgfoodrestaurant.com">contact@vgfoodrestaurant.com</a></p>
                    </div>
                </div>
                <div class="col-md-3 d-flex">
                    <div class="dbox">
                        <p><span>Website</span> <a href="#">vgfoodrestaurant.com</a></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row d-flex align-items-stretch no-gutters">
                <div class="col-md-6 p-5 order-md-last">
                    ...
                    <form id="form">
                        ...
                        <div class="form-group">
                            <input type="email" name="email" class="form-control" id="email" placeholder="Your Email" pattern="^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" >
                        </div>
                        <div class="form-group">
                            <input type="number" name="phone" class="form-control" id="phone" placeholder="Phone Number" pattern="^[0-9]{10}$" required >
                        </div>
                        <div class="form-group">
                            <textarea name="message" id="message" cols="30" rows="7" class="form-control" placeholder="Message"></textarea>
                        </div>
                        <div class="form-group">
                            <input type="button" id="submit" name="submit" value="Send Message" class="btn btn-primary py-3 px-5">
