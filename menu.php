...
<?php
$obj = new Meal();
$types = ['Lunch', 'Regular', 'Snacks', 'Beverages','Desserts' ];
            ...
            <div class="col-lg-12 d-block">
                <div class="row d-flex">
                    ...
                    <div class="col-md-5 pr-4 d-flex topper align-items-center text-lg-right justify-content-end">
                        <p class="mb-0 register-link"><span>Open hours:</span> <span>Monday - Sunday</span> <span>8:00AM - 10:00PM</span>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                ...
                <p class="breadcrumbs">
                    <span class="mr-2"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Meals <i class="ion-ios-arrow-forward"></i></span>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid px-4">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-4 menu-wrap">
                ...
                <?php ;
                $obj -> mealType = $type;
                $datas = $obj ->getmealType()

                ?>
                    <?php if(!empty($datas)): ?>
                    <?php foreach ($datas as $data): ?>
                        <div class="menus d-flex ftco-animate">
                            <div class="menu-img img" style="background-image: url('<?php echo $data['Image'] ?>')"></div>
                            <div class="text">
                                <div class="d-flex">
                                    <div class="one-half">
                                        <h3><?php echo $data['MealName']?></h3>
                                    </div>
                                    <div class="one-forth">
                                        <span class="price"><?php echo $data['Price'] ?> $</span>
                                    </div>
                                </div>
                                <p><?php echo $data['MealInfo'] ?></p>
                            </div>
                        </div>
    ...
    <div class="container-fluid px-0">
        <div class="row d-flex no-gutters">
            <div class="col-md-6 ftco-animate makereservation p-4 p-md-5 pt-5 pt-md-0">
                ...
                <form action="reservationProcess.php" method="POST" onsubmit="validateSubmit()" >
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-12 mt-3">
                            <div class="form-group">
                                <input type="submit" id="submit" name="submit" value="Make a Reservation" class="btn btn-primary py-3 px-5">
                            </div>
                        </div>
                    </div>
                </form>
        ...
        <div class="row mb-5">
            <div class="col-md-6 col-lg-3">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <p>Our Restaurant is the flagship brand of JADONS Ltd that has been proudly serving around the 1940s
                       located on the corner of Doi Can Street, Ba Dinh Dis, Ha Noi.</p>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <p>
                    ...
                    All rights reserved by GROUP2 C2007L APTECH APROTRAIN HANOI VIETNAM with
...
             var p = document.getElementById("phone").value;
			 ...
			 var x = document.getElementById("book_date").value;
			 var y = document.getElementById("book_time").value;
