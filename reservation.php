...
<head>
    ...
    <link rel="icon" href="assets/img/logotitle.gif" type="image/x-icon">
    <meta charset="utf-8">
    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                ...
                <p class="breadcrumbs">
                    <span class="mr-2"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Reservation <i class="ion-ios-arrow-forward"></i></span>
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="row d-flex no-gutters">
            <div class="col-md-6 order-md-last ftco-animate makereservation p-4 p-md-5 pt-5">
                <div class="py-md-5">
                    ...
                    <form action="reservationProcess.php" method="POST" onsubmit="return false">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12 mt-3">
                                <div class="form-group">
                                    <input type="button" id="submit" name="submit" value="Make a Reservation" class="btn btn-primary py-3 px-5">
